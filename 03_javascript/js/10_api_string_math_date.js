...
function test2() {
    ...
    alert(`입력하신 문자열 ${str}에서 아팔벳의 개수는 ${cnt}개입니다. 😀😁`);
}
...
function test3() {
    ...
    console.log(Math.trunc(12.34)); // 소수점이라 버림
 ...
 * - ul#nums하위에 li태그에 난수대입
 * - 짝수인 경우 컬러변경
 * - 메번 버튼 클릭시 숫자/컬러가 새로 지정되어야 함.
 */
function test4() {
...
function test5(){
 ...
 const date = new Date(1700460433700); // UTC Time을 Date객체 생성하기
 console.log(date);
